...
The `Krypton Suite` contains user interface components designed to make it quick and easy for developers to create professional looking applications. It provides the essential building blocks needed to create a consistent look and feel across all your products. You can use the built-in palettes to achieve the same appearance as industry standard applications such as _Microsoft Office 2007/2010/2013/365_, _Visual Studio_, _Material_, _Retro_, _OS X_ and _macOS_. Alternatively you can create your own custom palettes to create a completely unique user interface.

The `Krypton Suite` consists of five libraries called `Krypton Toolkit`, `Krypton Ribbon`, `Krypton Navigator`, `Krypton Workspace` and `Krypton Docking`. Extra libraries are included as part of the [Krypton.Standard.Toolkit](https://www.nuget.org/packages/Krypton.Standard.Toolkit) NuGet package.

## [Standard Toolkit on GitHub](https://github.com/Krypton-Suite/Standard-Toolkit)

* Modifications by Peter Wagner (aka [PWagner1](https://github.com/orgs/Krypton-Suite/people/PWagner1)), Simon Coghlan (aka [Smurf-IV](https://github.com/orgs/Krypton-Suite/people/Smurf-IV)), [Giduac](https://github.com/orgs/Krypton-Suite/people/giduac), Ahmed Abdelhameed (aka [Ahmed-Abdelhameed](https://github.com/orgs/Krypton-Suite/people/Ahmed-Abdelhameed)), [tobitege](https://github.com/orgs/Krypton-Suite/people/tobitege), [KamaniAR](https://github.com/orgs/Krypton-Suite/people/KamaniAR), Lesandro Gotardo (aka [lesandrog](https://github.com/orgs/Krypton-Suite/people/lesandrog)), Jorge A. Avilés (aka [mcpbcs](https://github.com/orgs/Krypton-Suite/people/lesandrog)) have been fixing and adding more capabilities to this toolkit.
...
* All .NET Versions from 4.6.2 are catered for (please see [for more information](articles/Support/PackageSupportInformation.md))
...
## [Krypton Toolkit](articles/Standard%20Toolkit/KryptonToolkit.md)
...
## [Krypton Ribbon](./articles/Standard%20Toolkit/KryptonRibbon.md)
...
## [Krypton Navigator](./articles/Standard%20Toolkit/KryptonNavigator.md)
...
## [Krypton Workspace](./articles/Standard%20Toolkit/KryptonWorkspace.md)
...
## [Krypton Docking](./articles/Standard%20Toolkit/KryptonDocking.md)
...
Want to contribute to the Standard Toolkit project? See the [contributing guide](./articles/Contributing.md).
