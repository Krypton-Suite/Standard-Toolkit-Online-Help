...
There are two ways of installing the .NET SDK Preview versions. Either via the .NET [downloads page](https://dotnet.microsoft.com/en-us/download/dotnet), or via WinGet:

```ps
winget install Microsoft.DotNet.SDK.Preview
```

Please check [.NET versions](../Support/PackageSupportInformation.md) for the latest updates.
