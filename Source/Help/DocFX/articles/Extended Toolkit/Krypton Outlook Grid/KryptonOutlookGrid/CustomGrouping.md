...
* 2. Overrides the *Text* property. Used for the text associated to the group and displayed in the grid.
* 3. Overrides the *Value*. Used for the value of the group that allows to select rows in the group and to sort groups between them.
