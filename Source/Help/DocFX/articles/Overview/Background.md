...
 
![Figure 1 –Background display properties](Background.png)
...
 
![*Figure 2 – ColorStyle = Solid*](BackgroundColor1.png)
...
 
![*Figure 3 – ColorStyle = Linear*](BackgroundColorAngle.png)
...
 
![*Figure 4 – ColorStyle =Sigma, ColorAlign = Form, ColorAngle = 45*](BackgroundColorAlign.png)
...
![*Figure 5 - Selection of some other ColorStyle options*](ColorStyle2.png)
...
 
![*Figure 6 – Color1 = Gold, Image contains alpha channel*](BackgroundImage.png)
...
 
![*Figure 7 – ImageAlign = Form, ImageEffect = Stretch*](BackgroundImageAlign.png)
...
 
![*Figure 8 – KryptonGroup with rounded border*](BackgroundHint1.png)
...
 
![*Figure 9 – Rounded border removed*](BackgroundHint2.png)
...
 
![*Figure 10 – GraphicsHint = AntiAlias*](BackgroundHint3.png)
