...
detail read the [Compacting](WorkspaceCompacting.md) section that describes reach of the
flags.
...
like hierarchy. For more details you should read the [Layout](WorkspaceLayout.md)
section followed by the related [Sizing](WorkspaceSizing.md) section.
