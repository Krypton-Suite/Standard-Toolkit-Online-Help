...
See also [Krypton.Toolkit.Utilities index](KryptonToolkitUtilitiesIndex.md) for V110+ controls in the utilities assembly.
...
#### 2. [KryptonManager.Strings API Reference](../Toolkit/Components/KryptonManagerStringsAPIReference.md)
...
#### 2b. [KryptonCustomStrings](KryptonCustomStrings.md) (V110+)

**Purpose:** Application-owned custom strings independent of built-in toolkit categories  
**Target Audience:** All developers localizing app-specific UI  
**Content:**

- `KryptonCustomStrings` static API (key/value and typed string sets)
- `KryptonCustomStringsManager` designer component
- Relationship to `KryptonManager.Strings`

**When to Use:** When you need localize application labels and messages outside the fixed `KryptonManager.Strings` categories.
...
3. **Refer:** [API Reference](../Toolkit/Components/KryptonManagerStringsAPIReference.md) - As needed for specific properties

### For Experienced Developers

1. **Browse:** [API Reference](../Toolkit/Components/KryptonManagerStringsAPIReference.md) - For specific property information
...
2. [API Reference](../Toolkit/Components/KryptonManagerStringsAPIReference.md) - "API Patterns and Conventions"
...
**See:** [API Reference](../Toolkit/Components/KryptonManagerStringsAPIReference.md) for complete list with all properties.
...
- See: [API Reference - GeneralRibbonStrings](../Toolkit/Components/KryptonManagerStringsAPIReference.md#generalribbonstrings)
...
- See: [API Reference - KryptonAboutBoxStrings](../Toolkit/Components/KryptonManagerStringsAPIReference.md#kryptonaboutboxstrings)

### Exception Handling

- Custom exception dialogs can use localized strings
- **V110+:** Public **`KryptonExceptionDialog`** is in **`Krypton.Toolkit.Utilities`** — see [KryptonExceptionDialog](../Toolkit/Components/KryptonExceptionDialog.md)
