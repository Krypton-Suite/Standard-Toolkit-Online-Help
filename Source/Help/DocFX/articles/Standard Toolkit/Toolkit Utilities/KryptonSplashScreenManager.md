...
`KryptonSplashScreenManager` in **Krypton.Toolkit.Utilities** is that implementation. It is **not** a replacement for the existing modal `KryptonSplashScreen` in `Krypton.Toolkit`.
