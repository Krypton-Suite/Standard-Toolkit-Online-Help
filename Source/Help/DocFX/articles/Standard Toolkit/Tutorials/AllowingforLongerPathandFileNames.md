...
![Group Policy Editor: Computer Configuration, Administrative Templates, System, Filesystem, with Enable Win32 Long paths highlighted](Images/Allowing%20Longer%20File%20Names/Group%20Policy%20Editor.png)

### Step 4

Double click the `Enable Win32 Long paths` setting, click `Enabled`, then click OK.

![Enable Win32 Long paths policy dialog with Enabled selected](Images/Allowing%20Longer%20File%20Names/Enable%20Win32%20Long%20Paths.png)
