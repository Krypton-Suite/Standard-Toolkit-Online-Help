...
### Step 2: Ensure that the Krypton Toolkit components are in the Toolbox

If not the [Using Krypton in Visual Studio 2022](UsingKryptoninVisualStudio2022.md)
tutorial can be used to add them.

### Step 3: Drag and drop three KryptonCheckButton instances onto the form

Place the controls in a vertical line as shown below.

![Designer: three KryptonCheckButton controls arranged vertically on the form](Images/MultiCheck1.png)

### Step 4: Use the KryptonCheckButton smart tags to enter ‘Text’ values of ‘Alpha’, ‘Beta’ and ‘Omega’
...
![Designer: KryptonCheckButton smart tags open for setting Text to Alpha, Beta, and Omega](Images/MultiCheck2.png)

### Step 5: Drag and drop a KryptonLabel instance below the check buttons

We will use the label control for feedback on the current choice selected.

![Designer: KryptonLabel placed below the three check buttons](Images/MultiCheck3.png)

### Step 6: Drag and drop a KryptonCheckSet instance onto the form
...
![Designer: KryptonCheckSet component in the component tray below the form](Images/MultiCheck4.png)

### Step 7: Find the ‘CheckButtons’ property in the properties window and press the ‘…’ button

The '...' button as shown below indicates that the collection will be edited by
showing a modal dialog.

![Properties window: KryptonCheckSet CheckButtons property with collection editor button](Images/MultiCheck6.png)

### Step 8: Select all three check button entries and press ‘OK’
...
![CheckButtons collection editor: all three KryptonCheckButton entries selected](Images/MultiCheck5.png)

### Step 9: Double click the ‘kryptonCheckSet1’ component
...
![Runtime: Alpha check button selected and label shows Alpha](Images/MultiCheck7.png)

![Runtime: Beta check button selected and label shows Beta](Images/MultiCheck8.png)
