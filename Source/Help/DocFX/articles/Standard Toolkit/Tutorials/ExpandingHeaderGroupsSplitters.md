...
![Visual Studio designer: new Windows Forms project with default empty form](Images/Normal%20WinForm%20Form.png)
...
![Form designer: KryptonForm with Krypton toolkit window chrome applied](Images/Three%20Pane%20Application/ThreePaneA1.png)

### Step 5: Drag a KryptonPanel from the toolbox and drop it in the centre of the form

When dropped it should look like the following picture.

![Designer: KryptonPanel placed in the center of the form](Images/Expanding%20HeaderGroups%20Splitters/SplittersA1.png)

### Step 6: Use the KryptonPanel smart tag and click ‘Dock in parent container’

The panel will now occupy the entire client area even when the form is resized.

![Designer: KryptonPanel docked in parent container filling the client area](Images/Expanding%20HeaderGroups%20Splitters/SplittersA2.png)

### Step 7: Modify the Padding property for the new KryptonPanel to 5 on all sides
...
![Designer: KryptonPanel with padding 5 on all sides](Images/Three%20Pane%20Application/ThreePane21.png)

### Step 8: Drag a KryptonSplitContainer from the toolbox and drop it inside the KryptonPanel

You should see text indicating the position of Panel1 and Panel2 areas.

![Designer: KryptonSplitContainer inside KryptonPanel showing Panel1 and Panel2 labels](Images/Expanding%20HeaderGroups%20Splitters/SplittersA3.png)

### Step 9: Drag a KryptonHeaderGroup from the toolbox and drop it inside Panel1

![Designer: KryptonHeaderGroup placed inside splitter Panel1](Images/Expanding%20HeaderGroups%20Splitters/SplittersA4.png)

### Step 10: Use the KryptonHeaderGroup smart tag and click ‘Dock in parent container’

The panel will now occupy the entire client area of Panel1.

![Designer: KryptonHeaderGroup docked to fill Panel1 of the split container](Images/Expanding%20HeaderGroups%20Splitters/SplittersA5.png)

### Step 11: Modify the KryptonHeaderGroup 'Text' and 'Image' properties

Use the properties window to find the 'ValuesPrimary' property and then set the
'Text' to 'Left' and remove the 'Image' value.

![Designer: left KryptonHeaderGroup primary header text set to Left](Images/Expanding%20HeaderGroups%20Splitters/Expanding6.png)

### Step 12: Modify the KryptonHeaderGroup 'HeaderVisibleSecondary' property to 'False'

This will remove from display the second header and leave the display as
follows.

![Designer: left KryptonHeaderGroup with secondary header hidden](Images/Expanding%20HeaderGroups%20Splitters/SplittersA6.png)

### Step 13: Find the 'ButtonSpecs' property and click the ellipses button

We we will use the collection property to define the header buttons.

![ButtonSpecs collection editor dialog for the left header group](Images/Expanding%20HeaderGroups%20Splitters/GroupHeader5.png)

### Step 14: Add one instance to the collection and set the 'Type' to 'Arrow Left'
...
![Collection editor: ButtonSpec with Type set to Arrow Left](Images/Expanding%20HeaderGroups%20Splitters/SplittersA7.png)

### Step 15: Initial setup of Left group is completed

You should now see the following picture as the initial display for the left
group.

![Designer: initial completed layout for the left header group and splitter](Images/Expanding%20HeaderGroups%20Splitters/SplittersA8.png)

### Step 16: Enter code view and add the following using statement
...
### Step 17: Hook into the header button click event
...
### Step 18: Add private field for remembering header width
...
### Step 19: Add button click handler code
...
![Application UI: left header group collapsed with vertical header and arrow](Images/Expanding%20HeaderGroups%20Splitters/SplittersA9.png)
...
![Application UI: initial three-pane layout before using the left header collapse button](Images/Expanding%20HeaderGroups%20Splitters/SplittersA10.png)

After using the header button it will then collapse down to the following.

## Part 2 - Expanding/Collapsing Right Panel

### Step 20: Drag a KryptonSplitContainer from the toolbox and drop it inside the right panel

You should see text indicating the position of new Panel1 and Panel2 areas.

![Designer: second KryptonSplitContainer placed in the right splitter panel](Images/Expanding%20HeaderGroups%20Splitters/SplittersB1.png)

### Step 21: Use the KryptonSplitContainer smart tag and click ‘Horizontal splitter orientation'

The splitter will now change to a vertical orientation with panel1 at the top
and panel2 at the bottom.

![Designer: nested splitter with horizontal orientation, panel1 top and panel2 bottom](Images/Expanding%20HeaderGroups%20Splitters/SplittersB2.png)

### Step 22: Drag a KryptonHeaderGroup from the toolbox and drop it inside Panel1

![Designer: KryptonHeaderGroup in the top panel of the nested vertical splitter](Images/Expanding%20HeaderGroups%20Splitters/SplittersB3.png)

### Step 23: Use the KryptonHeaderGroup smart tag and click ‘Dock in parent container'

This ensures the header group is always sized to fit the splitter panel size.

![Designer: top-right KryptonHeaderGroup docked in parent splitter panel](Images/Expanding%20HeaderGroups%20Splitters/SplittersB4.png)

### Step 24: Use the KryptonHeaderGroup smart tag and click ‘Hide secondary header'

We don't need the secondary header at the bottom for this example application.

![Designer: top-right KryptonHeaderGroup with secondary header hidden](Images/Expanding%20HeaderGroups%20Splitters/SplittersB5.png)

### Step 25: Drag a KryptonHeaderGroup from the toolbox and drop it inside Panel2

We now follow the same steps for the header group in the second splitter panel.

![Designer: KryptonHeaderGroup placed in the bottom panel of the nested splitter](Images/Expanding%20HeaderGroups%20Splitters/SplittersB6.png)

### Step 26: Use the KryptonHeaderGroup smart tag and click ‘Dock in parent container'

This ensures the header group is always sized to fit the splitter panel size.

### Step 27: Use the KryptonHeaderGroup smart tag and click ‘Hide secondary header'

You should end up with the following arrangement.

![Designer: both right-side KryptonHeaderGroups with secondary headers hidden](Images/Expanding%20HeaderGroups%20Splitters/SplittersB7.png)

### Step 28: Modify the top right KryptonHeaderGroup 'Text' and 'Image' properties

Use the properties window to find the ValuesPrimary property and then set the
'Text' to 'Right Top' and remove the 'Image' value.

![Designer: top-right KryptonHeaderGroup primary text set to Right Top](Images/Expanding%20HeaderGroups%20Splitters/Expanding35.png)

### Step 29: Modify the bottom right KryptonHeaderGroup 'Text' and 'Image' properties
...
![Designer: right top and right bottom header groups labeled in the layout](Images/Expanding%20HeaderGroups%20Splitters/SplittersB8.png)

### Step 30: Find the 'ButtonSpecs' property and click the ellipses button

With the bottom right header group still selected find and click the ellipses
button for the 'ButtonSpecs' property.

![ButtonSpecs collection editor dialog for the bottom-right header group](Images/Expanding%20HeaderGroups%20Splitters/GroupHeader5.png)

### Step 31: Add one instance to the collection and set the 'Type' to 'Arrow Down'
...
![Collection editor: ButtonSpec with Type set to Arrow Down](Images/Expanding%20HeaderGroups%20Splitters/SplittersB9.png)

### Step 32: Initial setup of right groups is completed

You should now see the following picture as the initial display for the
application.

![Designer: completed layout for right splitter panels and header groups](Images/Expanding%20HeaderGroups%20Splitters/SplittersB10.png)

### Step 33: Enter code view and hook into the button click event
...
### Step 34: Add private field for remembering header height
...
### Step 35: Add button click handler code
...
![Application UI: bottom-right region collapsed after using the down arrow header button](Images/Expanding%20HeaderGroups%20Splitters/SplittersB11.png)
