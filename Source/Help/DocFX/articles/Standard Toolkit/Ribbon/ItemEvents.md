...
Ribbon item types expose the following events:
...
### KryptonRibbonGroupButton and KryptonRibbonGroupClusterButton

*KryptonRibbonGroupButton* and *KryptonRibbonGroupClusterButton* share the following events.
