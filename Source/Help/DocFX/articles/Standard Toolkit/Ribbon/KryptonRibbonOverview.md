...
This is the root property used to define individual tabs for the ribbon. As a collection property you can use it to add/remove and update tab instances. Each tab itself has a Groups property for defining the contents of the tab when it is selected. For more detail, see [Ribbon tabs](KryptonRibbonTabs.md).

### SelectedContext

When using contextual tabs you use this property to define which contexts are currently displayed. The value is a comma separated list of context names where the contexts are displayed in the same order as they appear in the property. For more information, see [Contextual tabs](KryptonRibbonContextualTabs.md).
...
![Ribbon control Visuals category properties in the Properties window](Images/RibbonVisualsProps.png)
