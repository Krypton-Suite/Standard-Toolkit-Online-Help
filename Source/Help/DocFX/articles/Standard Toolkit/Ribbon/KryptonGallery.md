...
![KryptonGallery gallery-specific properties shown in the Visual Studio Properties window](Images/GalleryProps.png)
...
![Two KryptonGallery controls comparing PreferredItemSize values 5,1 and 4,2](Images/GalleryPreferredItemSize.png)
