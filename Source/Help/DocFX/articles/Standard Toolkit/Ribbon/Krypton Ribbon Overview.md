...
![Figure 1 - Ribbon Values Properties](Images/RibbonValuesProps.png)
...
*Word 2007* and *Excel 2007*. For more details on using this property, see the
[Ribbon ButtonSpecs documentation](ButtonSpecs.md).
...
### QATButtons, QATLocation, and QATUserChange
...
see [Quick access toolbar](KryptonRibbonQuickAccessToolbar.md).
...
get more details about the application button and these properties in
[Krypton ribbon application button properties](KryptonRibbonApplicationButton.md).
...
displayed context. For more information, see [Ribbon contextual tabs](KryptonRibbonContextualTabs.md).
...
is selected. For more detail, see [Ribbon tabs](KryptonRibbonTabs.md).
...
more information, see [Ribbon contextual tabs](KryptonRibbonContextualTabs.md).
...
![Figure 2 - Ribbon Visuals Properties](Images/RibbonVisualsProps.png)
...
An additional state-related property, *OverrideFocus*, is used to alter the
appearance of the control when it has the focus. Notice that the property starts
with the *Override* prefix instead of the usual *State*. This is because it does
not relate to a specific control state such as *Normal* or *Tracking*. Instead
it is applied to any of the other states and is used to override the appearance
