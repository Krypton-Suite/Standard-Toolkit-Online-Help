...
> **Superseded:** This guide describes `KryptonLanguageManager`, which is not part of the current toolkit. Use **[Localization Guide](LocalizationGuide.md)** for built-in `KryptonManager.Strings` localization and **[KryptonCustomStrings](KryptonCustomStrings.md)** for application-owned custom strings (V110+).
