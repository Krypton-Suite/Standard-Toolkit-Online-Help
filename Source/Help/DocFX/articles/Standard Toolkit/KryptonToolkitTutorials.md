...
Illustrations in the table below use **suite overview screenshots** checked in under `Tutorials/Images/_suite-examples/` (sourced from the [Krypton-Suite/Help-Files](https://github.com/Krypton-Suite/Help-Files) repository on GitHub) so the help build stays self-contained. They are representative of the toolkit rather than step‑for‑step captures for each tutorial.
  
## Krypton Toolkit Tutorials

| [Using Krypton in Visual Studio 2022](Tutorials/UsingKryptoninVisualStudio2022.md) | [Using Images With Buttons](Tutorials/UsingImagesWithButtons.md) |
| --- | --- |
...
| [Embedding Palette Definitions](Tutorials/EmbeddingPaletteDefinitions.md)                                                                                                            | [Multiple Choice Buttons](Tutorials/MultipleChoiceButtons.md)        |
|
...
| ![Krypton Toolkit group example](Tutorials/Images/_suite-examples/KryptonToolkitExampleGroup.png) | ![Krypton Toolkit form example](Tutorials/Images/_suite-examples/KryptonToolkitExampleForm.png) |
| [Three Pane Application](Tutorials/ThreePaneApplication.md)                                                                                                                          | [Expanding HeaderGroups (Splitters)](Tutorials/ExpandingHeaderGroupsSplitters.md)                                                                                                  |
...
| ![Krypton Workspace example](Tutorials/Images/_suite-examples/KryptonWorkspaceExample.png) | ![Krypton Navigator example](Tutorials/Images/_suite-examples/KryptonNavigatorExample.png) |
| [Expanding HeaderGroups (DockStyle)](Tutorials/ExpandingHeaderGroupsDockStyle.md)                                                                                                    | [Expanding HeaderGroups (Stack)](Tutorials/ExpandingHeaderGroupsStack.md)                                                                                                          |
...
| ![Krypton Docking example](Tutorials/Images/_suite-examples/KryptonDockingExampleCustomised.png) | ![Krypton Ribbon example](Tutorials/Images/_suite-examples/KryptonRibbonExample.png) |
...
| ![Krypton Navigator example](Tutorials/Images/_suite-examples/KryptonNavigatorExample.png) |
