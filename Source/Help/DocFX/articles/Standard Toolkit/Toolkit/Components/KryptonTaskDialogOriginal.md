...
![KryptonTaskDialog example dialog with main instruction, content, footer, checkbox, and standard buttons](../Images/KryptonTaskDialogAll.png)
...
![KryptonTaskDialog component properties listed in the designer property grid](../Images/KryptonTaskDialogProps.png)
