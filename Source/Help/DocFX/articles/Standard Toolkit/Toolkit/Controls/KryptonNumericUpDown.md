...
![KryptonNumericUpDown with InputControlStyle Standalone (default appearance)](../Images/KNumericUpDown.bmp)
...
![KryptonNumericUpDown with InputControlStyle Ribbon and AlwaysActive False (inactive vs mouse over)](../Images/KNumericUpDown2.bmp)
...
![KryptonNumericUpDown showing a ButtonSpec at the Far edge (ButtonSpec style, Context type)](../Images/KNumericUpDown3.bmp)
