...
![KryptonDateTimePicker with InputControlStyle Standalone (default appearance)](../Images/KryptonDateTimePicker1.png)
...
![KryptonDateTimePicker with InputControlStyle Ribbon and AlwaysActive False (inactive vs mouse over)](../Images/KryptonDateTimePicker2.png)
...
![KryptonDateTimePicker with a ButtonSpec at the Far edge (ButtonSpec style, Context type)](../Images/KryptonDateTimePicker3.png)
