...
If you have loaded a custom palette into a [KryptonCustomPaletteBase](../Components/KryptonCustomPaletteBase.md) control, then you will need to assign it to the *GlobalCustomPalette* property. When this property is set to use a *KryptonCustomPaletteBase*, the *GlobalPaletteMode* will automatically be set to *Custom*.
...
The *ToolkitImages* property is where you can define your own images that are used throughout the toolkit. The [KryptonIntegratedToolBarManager](../Components/KryptonIntegratedToolBarManager.md) uses these images on toolbars, as well as [KryptonAboutBox](../Components/KryptonAboutBox.md).
