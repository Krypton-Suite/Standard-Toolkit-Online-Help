...
![Visual Studio properties window showing the ButtonSpecs collection property on a KryptonHeader control](../Images/ButtonSpecsProperty.png)
...
![Collection editor with a ButtonSpec selected and its properties listed on the right](../Images/ButtonSpecProperties.png)
...
![KryptonHeader control with header text and no ButtonSpec buttons visible](../Images/HeaderButtons1.png)
...
![ButtonSpec with a red cross image shown in normal, hover, and pressed states](../Images/HeaderButtons2.png)
...
![ButtonSpec displaying image, text, and extra text together on a KryptonHeader](../Images/HeaderButtons3.png)
...
![ButtonSpec using Standalone style with visible background and border when idle](../Images/HeaderButtons4.png)
...
![ButtonSpec placed on the near (left) edge of a KryptonHeader using Edge Near](../Images/HeaderButtons5.png)
...
![ButtonSpec rendered in a disabled appearance with Enabled set to False](../Images/HeaderButtons6.png)
...
![ButtonSpec drawn as a checked toggle button on a KryptonHeader](../Images/HeaderButtons7.png)
...
![Four ButtonSpec instances showing Previous, Next, Context, and Close predefined types](../Images/HeaderButtons8.png)
...
![KryptonHeader in vertical orientation with ButtonSpec buttons rotated using Orientation Auto](../Images/HeaderButtons9.png)
...
![Vertical KryptonHeader with ButtonSpec orientation fixed to FixedTop](../Images/HeaderButtons10.png)
...
![Two KryptonHeader styles showing palette icons remapped to header text colors via ColorMap](../Images/HeaderButtonsA.png)
...
![Close-type ButtonSpec with custom text remapped to match changing header content colors](../Images/HeaderButtonsB.png)
