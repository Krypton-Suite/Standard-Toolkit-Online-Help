...
![KryptonColorButton showing SelectedColor Red, Green, Blue, and Empty with EmptyBorderColor](../Images/KryptonColorButton1.png)

Figure 1 – SelectedColor and EmptyBorderColor Properties

![KryptonColorButton showing default SelectedRect and two custom rectangle placements](../Images/KryptonColorButton4.png)
...
![KryptonColorButton default color picker context menu (Themes, Standard, Recent, No Color, More Colors)](../Images/KryptonColorButton2.png)
...
![KryptonColorButton context menu with SchemeThemes Basic16 and SchemeStandard Mono8](../Images/KryptonColorButton3.png)
...
![KryptonColorButton drop-down appearance: idle, tracking split areas, and open context menu](../Images/KryptonColorButton5.png)
