...
![KryptonHeaderGroup examples showing HeaderPositionPrimary and HeaderPositionSecondary layouts](../Images/KryptonHeaderGroup1.png)
...
write a single line of code. Check out the [Expanding HeaderGroups (DockStyle)](../../Tutorials/ExpandingHeaderGroupsDockStyle.md) tutorial to see the detailed steps.
...
![KryptonHeaderGroup comparing OverlayHeaders True and False with a thick red border](../Images/KryptonHeaderGroup2.png)
...
![KryptonHeaderGroup with ButtonSpecs on the headers](../Images/KryptonHeaderGroup3.png)
...
![KryptonHeaderGroup appearance examples in Disabled and Normal states (Office 2003 and System palettes)](../Images/KryptonHeaderGroup4.png)
