...
looking at *Figure 2*. The left image is the *List* style when the *Office 2007 - Blue* palette is used and the right image is the same palette but with the
*Sheet* style.
...
You should always use the Krypton specified version of the column type whenever
