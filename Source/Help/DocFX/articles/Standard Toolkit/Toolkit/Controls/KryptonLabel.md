...
![KryptonLabel examples showing Top, Bottom, Left, and Right orientation values](../Images/KryptonLabel1.png)
...
![KryptonLabel appearance for Title and Normal label styles in Disabled and Normal states](../Images/KryptonLabel2.png)
