...
![KryptonButton examples showing Top, Bottom, Left, and Right orientation values](../Images/KryptonButton1.png)
...
![KryptonButton with ButtonStyle Standalone showing disabled, normal, tracking, pressed, and override states](../Images/KryptonButton2.png)
...
![KryptonButton with ButtonStyle LowProfile showing transparent normal state and hover emphasis](../Images/KryptonButton3.png)
