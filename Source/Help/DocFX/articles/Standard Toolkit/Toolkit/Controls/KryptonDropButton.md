...
![KryptonDropButton comparing Splitter off and on](../Images/KryptonDropButton1.png)

Figure 1 – Splitter Property

![KryptonDropButton showing Top, Bottom, Left, and Right ButtonOrientation values](../Images/KryptonDropButton2.png)

Figure 2 – ButtonOrientation Property

![KryptonDropButton showing Left, Right, Top, and Bottom DropDownPosition values](../Images/KryptonDropButton3.png)

Figure 3 – DropDownPosition Property

![KryptonDropButton showing DropDownOrientation Above, Below, Left, and Right](../Images/KryptonDropButton4.png)
...
![KryptonDropButton drop-down appearance: idle, tracking split areas, and open context menu](../Images/KryptonDropButton5.png)
